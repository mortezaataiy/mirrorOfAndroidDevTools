...
- [ ] ۱۰. تست workflow توسط GitHub CLI
  - [ ] ۱۰.۱ اجرای workflow برای تست
    - اجرای workflow با دستور `gh workflow run`
    - بررسی وضعیت اجرا با `gh run list`
    - _الزامات: تمام الزامات_

  - [ ] ۱۰.۲ بررسی نتایج و خروجی
    - دانلود artifacts با `gh run download`
    - بررسی فایل YAML تولید شده
    - تأیید موفقیت بیلد Hello World
    - _الزامات: تمام الزامات_

- [ ] ۱۱. نقطه بررسی نهایی - اطمینان از عملکرد تست‌ها
  - اطمینان از گذراندن تمام تست‌ها، در صورت بروز سؤال از کاربر پرسیده شود.
