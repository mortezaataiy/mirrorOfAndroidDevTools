...
- **Compatibility_Tester**: ماژول تست سازگاری در GitHub Actions
- **Version_Database**: فایل YAML حاوی اطلاعات ورژن‌ها و لینک‌ها
- **Hello_World_Builder**: ماژول ایجاد و بیلد پروژه تست
...
### الزام ۲: تست سازگاری در GitHub Actions

**داستان کاربر:** به عنوان مدیر پروژه، می‌خواهم مطمئن شوم که ورژن‌های شناسایی شده با یکدیگر سازگار هستند.

#### معیارهای پذیرش

1. هنگامی که ورژن‌های جدید شناسایی می‌شوند، سیستم باید آنها را در محیط ویندوز GitHub Actions دانلود کند
2. هنگامی که ابزارها دانلود می‌شوند، سیستم باید آنها را نصب و پیکربندی کند
3. هنگامی که ابزارها نصب می‌شوند، سیستم باید یک پروژه Hello World اندروید ایجاد کند
4. هنگامی که پروژه Hello World ایجاد می‌شود، سیستم باید آن را کامپایل و بیلد کند
5. اگر بیلد موفقیت‌آمیز نباشد، سیستم باید خطا را گزارش کرده و فرایند را متوقف کند
...
### الزام ۷: تست Hello World

**داستان کاربر:** به عنوان تست‌کننده، می‌خواهم مطمئن شوم که ابزارهای نصب شده قادر به ایجاد یک پروژه کاربردی هستند.

#### معیارهای پذیرش

1. هنگامی که ابزارها نصب می‌شوند، سیستم باید یک پروژه اندروید جدید ایجاد کند
2. هنگامی که پروژه ایجاد می‌شود، سیستم باید یک Activity ساده با متن "Hello World" اضافه کند
3. هنگامی که کد نوشته می‌شود، سیستم باید پروژه را کامپایل کند
4. هنگامی که کامپایل موفقیت‌آمیز است، سیستم باید فایل APK تولید کند
5. هنگامی که APK تولید می‌شود، سیستم باید اندازه و یکپارچگی آن را بررسی کند
